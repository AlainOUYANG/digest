...
const items = [
  { title: 'A', link: 'https://x/a', author: 'a', source: 's', snippet: 'sa', isoDate: '2026-07-12T10:00:00Z' },
  { title: 'B', link: 'https://x/b', author: 'b', source: 's', snippet: 'sb', isoDate: '2026-07-12T09:00:00Z' },
  { title: 'C', link: 'https://x/c', author: 'c', source: 's', snippet: 'sc', isoDate: '2026-07-12T11:00:00Z' },
];
